    ...
    BuiltinData builtinData)
{
    ...
    float3  color;
    float   attenuation = 0;
    EvaluateLight_Directional(lightLoopContext, posInput, lightData, builtinData, normalWS, lightWS, bsdfData.specularOcclusion, color, attenuation);
    ...
    out float3 diffuseLighting, out float3 specularLighting)
{
    ...
    */
    ...
    //UV = bsdfData.flakesUV;
    //specularLighting = SAMPLE_TEXTURE2D_ARRAY_LOD(_AxFLtcData, s_linear_clamp_sampler, UV, 3, 0).xyz;
